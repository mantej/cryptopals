...
# https://gist.github.com/tristanwietsma/5937448
#
...
# returns MD4(key || message)
def authMD4(key, message):
    m = MD4()
    m.update(key+message)
    return m.digest()

def main():
    #print authMD4("a", "bc") == "a448017aaf21d8525fc10ae87aa6729d"
    #print authMD4("message ", "digest") == "d9130a8164549fe818874806e1c7014b"

    if len(sys.argv) < 3:
        print "[*] Usage: python md4.py key message"
        exit(0)

    # secret-prefix MAC
    print authMD4(sys.argv[1], sys.argv[2])
